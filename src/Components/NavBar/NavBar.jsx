...
class NavBar extends React.Component {
    render() {
        ...
        <div className='navbar-container'>
            <a href='https://about.facebook.com/meta/'><img src={logo} alt="logo" className='navbar-img' /></a>
            <a href='https://about.facebook.com/meta/'><div className='item1'> METUHH </div></a>
