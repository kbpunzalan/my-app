...
import jake from './pics/friends/jake.jpg'
...
const myFriends = [
    ...
    { name: "Jake de Dog", image: jake, mutual: 101, id: 6},
    { name: "Yor Cutie", image: yor, mutual: 9999999, id: 7}
...
const friendPost = [
    ...
    { author: myFriends[6].name, image: myFriends[6].image, timestamp: "05/05/2022 | 16:19", content: "Anime Waifus for LENI-KIKO! 🌸🌸" }
];
